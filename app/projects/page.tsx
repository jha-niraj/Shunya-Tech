...
import { Code2, ArrowUpRight, Filter, Database, Layers, Eye, FileText } from "lucide-react"
...
const projectData = [
    {
        id: 1,
        slug: "the-coderz", // Updated for routing
        title: "The Coder'z",
                ...
                <section className="relative pt-32 pb-16 px-6">
                    <div className="relative max-w-7xl mx-auto">
                        ...
                        <motion.div
                            ...
                            className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20 border-b border-neutral-200 dark:border-neutral-800 pb-12"
                        >
                            <div className="max-w-3xl">
                                ...
                                <p className="text-xl text-neutral-500 font-light max-w-xl">
                                    ...
                                    <div className="p-6 flex flex-col flex-1">
                                        ...
                                        <div className="mt-auto grid grid-cols-2 gap-3">
                                            <Link href={project.link} target="_blank" className="w-full">
                                                <button className="w-full py-2.5 rounded-xl border border-neutral-200 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-800 text-sm font-medium transition-colors flex items-center justify-center gap-2">
                                                    <Eye className="w-4 h-4" /> Live Demo
                                                </button>
                                            </Link>

                                            {/* Link to Dynamic Details Page using Slug */}
                                            <Link href={`/projects/${project.slug}`} className="w-full">
                                                <button className="w-full py-2.5 rounded-xl bg-neutral-900 dark:bg-white text-white dark:text-black hover:opacity-90 text-sm font-bold transition-opacity flex items-center justify-center gap-2">
